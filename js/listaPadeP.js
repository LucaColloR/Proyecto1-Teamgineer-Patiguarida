...
const tabla = document.querySelector('#tbl-padecimientos-perro tbody');

const mostrarTabla = () => {
    listaPadecimientoPerro.forEach(mascotas => {
        ...
        btnAgregar.addEventListener('click', agregarPadecimientosPerro);
        ...
        btnBorrar.addEventListener('click', borrarPadecimientosPerro);
...
function agregarPadecimientosPerro() {
    Swal.fire({
...
function borrarPadecimientosPerro() {
    Swal.fire({
        'icon': 'warning',
